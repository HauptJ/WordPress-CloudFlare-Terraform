...
ansible-vault encrypt ansible/group_vars/wordpress/vault.yml --vault-password-file ~/deploy.vault
ansible-vault encrypt ansible/group_vars/cv/vault.yml --vault-password-file ~/deploy.vault
